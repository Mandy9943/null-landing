!(function () {
  ...
  ((t) => {
    ...
    const { hostname: f, href: m, origin: p } = o,
      ...
      L = v(g + "domains") || "",
      $ = v(g + "fetch-credentials") || "omit",
      E = L.split(",").map((t) => t.trim()),
      K = `${(S || "https://api-gateway.umami.dev").replace(
        /\/$/,
        ""
      )}/api/send`,
      O = `${e}x${a}`,
      ...
      I = () => {
        M ||
          ...
          (() => {
            ...
            (s.pushState = t(s, "pushState", W)),
              (s.replaceState = t(s, "replaceState", W));
          })(),
          (() => {
            const t = async (t) => {
      ...
      q = (t, e) => (
        "string" == typeof t && (F = t),
        (z = ""),
        C({ ...R(), data: "object" == typeof t ? t : e }, "identify")
      );
    t.umami || (t.umami = { track: J, identify: q });
    let z,
      F,
      G = P(m),
      H = P(h.startsWith(p) ? "" : h),
      M = !1,
      Q = !1;
    T &&
      !B() &&
      ("complete" === c.readyState
        ? I()
        : c.addEventListener("readystatechange", I, !0));
  })(window);
})();
